<?php namespace PharmaIntelligence\HL7;
...
use PharmaIntelligence\HL7\Node\Segment\NTESegment;
use PharmaIntelligence\HL7\Node\Segment\MSHSegment;
use PharmaIntelligence\HL7\Node\Segment\OBRSegment;
use PharmaIntelligence\HL7\Node\Segment\OBXSegment;
use PharmaIntelligence\HL7\Node\Segment\ORCSegment;
use PharmaIntelligence\HL7\Node\Segment\PIDSegment;
use PharmaIntelligence\HL7\Node\Segment\SPMSegment;
...
class Unserializer
{
    ...
    protected $segmentClassMap = [
        MSHSegment::IDENTIFIER => MSHSegment::class,
        NTESegment::IDENTIFIER => NTESegment::class,
        OBRSegment::IDENTIFIER => OBRSegment::class,
        OBXSegment::IDENTIFIER => OBXSegment::class,
        ORCSegment::IDENTIFIER => ORCSegment::class,
        PIDSegment::IDENTIFIER => PIDSegment::class,
        SPMSegment::IDENTIFIER => SPMSegment::class,
        ];
    ...
    public function loadMessageFromString($hl7String, $segmentClassMap = [])
    {
        $this->hl7String = $hl7String;
        $this->segmentClassMap = array_merge($segmentClassMap, $this->segmentClassMap);
